...
### Step1: if you start from FASTQ files
...
### Step2: (Optional) Infer strandness from BAM files
...
### Step3: If you start from aligned BAM files or you have generated BAM files as above

...
### If you start from FASTQ files, modify the job file submit_1_star_alignment_template.sh in the main work directory. For this step, you need the following: 
...
### (Optional) If you are not sure about what strand parameters to use in the following splicing_junction_pipeline, run the helper script in [Strand-specificity](#strand-specificity)). 

### If you start from aligned BAM files or you have generated BAM files as above, modify the job file submit_3_splicing_junction_pipeline_template.sh in the main work directory. You need the following:  
